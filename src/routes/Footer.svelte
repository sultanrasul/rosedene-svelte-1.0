          ...
          <div class="lg:flex lg:justify-between lg:items-center">
            <div class="flex flex-wrap items-center gap-3">
              <div class="flex items-center gap-4 mt-8 mb-12">
                ...
                <!-- Trust Badges -->
                <!-- <div class="flex-1 pl-6 border-l border-[#C09A5B]/10">
                  <div class="space-y-2">
                    <div class="flex items-center gap-3 text-[#C09A5B]/80 hover:text-[#C09A5B] transition-colors">
                      <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                      </svg>
                      <span class="text-sm">SSL Secure Payments</span>
                    </div>
                    <div class="flex items-center gap-3 text-[#C09A5B]/80 hover:text-[#C09A5B] transition-colors">
                      <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
